...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 05 août 2025 à 18:58
...
CREATE TABLE `objectifs_users` (
  ...
  `titre` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
  `metric` enum('Pourcentage','Score','Nombre','Temps') NOT NULL DEFAULT 'Pourcentage',
  `valeur` int(11) NOT NULL,
  `poids` int(11) NOT NULL,
  `date_debut` date NOT NULL,
  `date_fin` date NOT NULL,
  `statut_objectif` enum('En Attente de Validation','Valider','Rejeter') NOT NULL DEFAULT 'En Attente de Validation',
  `id_cycle` bigint(20) UNSIGNED NOT NULL,
  `manager_id` bigint(20) UNSIGNED DEFAULT NULL,
  `agent_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `secondname`, `user_job_name`, `direction_id`, `statut_user`, `manager_id`) VALUES
(1, 'Jean', 'jean.dupont@example.com', NULL, '$2y$12$tfcvY4Q/0yxzddVJIRwMr.Sa2kY0R/pm6BA8VZA1kh6Foia3ukl.2', NULL, '2025-06-03 14:23:51', '2025-06-21 19:00:55', 'Dupont', 'IT Support', 1, 'Actif', NULL),
(2, 'Yoan', 'yoantioma4@gmail.com', NULL, '$2y$12$6NRNsXe17kkSQPKSnLs9YO1Fx6RsoA/NrfUBYLsHtd2H2dYCDfR3q', NULL, '2025-06-04 03:04:57', '2025-06-04 09:58:55', 'Tioma', 'Analyste Développeur', 1, 'Actif', 1),
(5, 'Jonathan', 'jonathan@example.com', NULL, '$2y$12$43JSgZ0/.IDUnL/hN6S6QOOsW1U2.00snOCgKA.UCYWdDovYjDAfC', NULL, '2025-06-16 14:03:33', '2025-06-16 14:03:33', 'Aspirine', 'Développeur', 1, 'Actif', NULL),
(7, 'Aspirine', 'jesuisfort@gmail.com', NULL, '$2y$12$GfAHpGB0.17XmZNSUmiP4ejKl9LVhGgYOQD0smd4z0GvBu.19VqJ6', NULL, '2025-06-17 12:27:38', '2025-06-23 07:35:54', 'Jonathan', 'Développeur Frontend', 1, 'Actif', 1),
(8, 'Yoan', 'azebaze@gmail.com', NULL, '$2y$12$WuNOGIZm3XXrDzjW79Onpehjyk/sO3XxaXCkyDd2vJsfHtPMJAcQe', NULL, '2025-06-27 18:00:49', '2025-07-10 08:34:13', 'AZEBAZE', 'Data Base Administrator', 1, 'Actif', NULL),
(10, 'comite1', 'comite1@gmail.com', NULL, '$2y$12$W9kI9c.SDpXTj.4c4knmhOP/PMR8T9HJJQhx0lXWZM1mfJx2XCkby', NULL, '2025-07-25 11:03:45', '2025-07-25 11:03:45', 'comite1', 'comite1', NULL, 'Actif', NULL),
(11, 'Alice', 'alice.ngono@example.com', NULL, '$2y$12$dgRtGZ4xp76Nxkv6BK5Kcu66QftvLPJCnOA6i5QogTC9E.qhHOUkW', NULL, '2025-07-27 01:18:39', '2025-07-27 01:18:39', 'Ngono', 'Secrétaire Comité', 1, 'actif', 1),
(12, 'Brice', 'brice.mbarga@example.com', NULL, '$2y$12$HwkAYfavbKjwgD23gZVEo.E1YASSh3y6HWS9FERj1sDmqCRY1Jy4q', NULL, '2025-07-27 01:19:09', '2025-07-27 01:19:09', 'Mbarga', 'Coordonnateur Comité', 1, 'actif', 1),
(13, 'Cynthia', 'cynthia.ewodo@example.com', NULL, '$2y$12$QMSCY5mTxqNzvJl/5RAof.YWITFbsUx610IRBiGDa6s/cBUuUWaYG', NULL, '2025-07-27 01:19:26', '2025-07-27 01:19:26', 'Ewodo', 'Assistante Comité', 1, 'actif', 1),
(14, 'Dieudonné', 'dieudonne.essomba@example.com', NULL, '$2y$12$4FcSSmMH3bYY1IdByO.aeOXDcoTBghajXt/7Bs2YBvmrwRL6Immse', NULL, '2025-07-27 01:19:42', '2025-07-27 01:19:42', 'Essomba', 'Membre Comité', 1, 'actif', 1),
(15, 'Estelle', 'estelle.tchana@example.com', NULL, '$2y$12$F4TUPfm4TW0aqil8BAJunuKN3wQigrPdlu3BuFZi.lDXnO4rz50..', NULL, '2025-07-27 01:20:03', '2025-07-27 01:20:03', 'Tchana', 'Responsable Comité', 1, 'actif', 1);
